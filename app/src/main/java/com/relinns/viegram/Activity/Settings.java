...
public class Settings extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    LinearLayout logout, change_password, viegram_works, terms_service, icon_guide, edit_profile, invite_friends;

    RelativeLayout badgeLayout, back, activity_layout, support, follow_people_button, menu_home, menu_open_layout, menu_close, menu_profile, menu_stat, menu_follow, menu_notifications, menu_settings, menu_search, menu_ranking, menu_camera;

    ImageView menu_click_view;

    Switch private_account;

    CheckBox like_box, comment_box, tag_box, follow_request_box, repost_box;
    ...
    static List<CommentPost> followPeople;
