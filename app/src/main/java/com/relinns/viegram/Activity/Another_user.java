            ...
            public void onResponse(Call<API_Response> call, retrofit2.Response<API_Response> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (result.getMsg().equals("201")) {
                        ...
                        loader2.displayImage(result.getProfile_details().getProfileImage(),another_profile_image, options2);
                       ...
                       /* Glide.with(Another_user.this).load(result.getProfile_details().getProfileImage())
                        ...
                        ImageLoader loader3 = ImageLoader.getInstance();
                        loader3.displayImage(result.getProfile_details().getCoverImage(),another_cover_imaage, options3);
