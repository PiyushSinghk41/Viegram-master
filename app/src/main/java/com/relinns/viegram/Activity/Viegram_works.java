...
public class Viegram_works extends AppCompatActivity implements View.OnClickListener {
    ...
    RelativeLayout back, badgeLayout, activity_layout, menu_home, menu_open_layout, menu_close, menu_profile, menu_stat, menu_follow, menu_notifications, menu_settings, menu_search, menu_ranking, menu_camera;
    ...
    String url = "http://www.viegram.com/viegram_pages/viegram_work.html";
