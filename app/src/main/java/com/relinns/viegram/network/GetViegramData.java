...
//    @Headers("Content-Type:application/json")
    @Multipart
    @POST("upload_object.php")
    Call<API_Response> UploadVideo(@Part MultipartBody.Part filename,
                                   @Part MultipartBody.Part thumbnail,
                                   @Part("action") RequestBody action,
                                   @Part("userid") RequestBody userid,
                                   @Part("caption") RequestBody caption,
                                   @Part("file_type") RequestBody file_type,
                                   @Part("restricted_status") RequestBody restricted_status,
                                   @Part("tag_people") RequestBody tag_people,
                                   @Part("location") RequestBody location,
                                   @Part("x_cordinates") RequestBody x_cordinates,
                                   @Part("y_cordinates") RequestBody y_cordinates);


//    @Headers("Content-Type:application/json")
    @Multipart
    @POST("upload_object.php")
    Call<API_Response> UploadImage(@Part MultipartBody.Part filename,
                                   @Part("action") RequestBody action,
                                   @Part("userid") RequestBody userid,
                                   @Part("caption") RequestBody caption,
                                   @Part("file_type") RequestBody file_type,
...
//    @Headers("Content-Type:application/json")
    @Multipart
    @POST("upload_object.php")
    Call<API_Response> EditProfile(@Part MultipartBody.Part profileimage,
                                   @Part MultipartBody.Part coverimage,
                                   @Part("action") RequestBody action,
                                   @Part("userid") RequestBody userid,
                                   @Part("full_name") RequestBody full_name,
                                   @Part("bio_data") RequestBody bio_data,
...
//    @Headers("Content-Type:application/json")
    @Multipart
    @POST("upload_object.php")
    Call<API_Response> updateprofilesingle(@Part MultipartBody.Part image,
                                           @Part("action") RequestBody action,
                                           @Part("userid") RequestBody userid,
                                           @Part("full_name") RequestBody full_name,
                                           @Part("bio_data") RequestBody bio_data,
...
//    @Headers("Content-Type:application/json")
    @Multipart
    @POST("upload_object.php")
    Call<API_Response> updateprofile(@Part("action") RequestBody action,
                                     @Part("userid") RequestBody userid,
                                     @Part("full_name") RequestBody full_name,
                                     @Part("bio_data") RequestBody bio_data,
                                     @Part("link") RequestBody link,
